...
# Utility function handles the clone/reset logic for git sources to avoid 
# unneccessary downloads.
function git_clone {
	nop=""
}
...
# Compile binutils
if [ ! -e binutils-2.23.2/.built ]; then
...
if [ ! -e mingwrt-3.20-mingw32/.built ]; then
